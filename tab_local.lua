...
local function get_formspec(tabview, name, tabdata)
	...
	retval = retval ..
			"button[4.70,3.8;2.8,1;world_delete;".. fgettext("Delete") .. "]" ..
			"button[7.70,3.8;2.8,1;world_configure;".. fgettext("Select Mods") .. "]" ..
			"button[1.70,3.8;2.8,1;world_create;".. fgettext("New") .. "]" ..
			"label[2,-0.05;".. fgettext("Select World:") .. "]"..
			creative ..
			damage ..
			host ..
			"textlist[2,0.4;7.9,3.45;sp_worlds;" ..
	...
	if core.settings:get_bool("enable_server") and disabled_settings["enable_server"] == nil then
		...
		retval = retval ..
				"button[4.1,4.75;4.1,1;play;" .. fgettext("Play Game") .. "]"
	end
